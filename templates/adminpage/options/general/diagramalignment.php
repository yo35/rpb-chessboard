...
<h3><?php _e('Diagram alignment', 'rpbchessboard'); ?></h3>
...
<div class="rpbchessboard-graphicRadioButtonFields">
	...
	<div>
		...
		/>
		<label for="rpbchessboard-diagramAlignmentButton-center" title="<?php _e('Centered', 'rpbchessboard'); ?>">
			<img src="<?php echo RPBCHESSBOARD_URL . 'images/alignment-center.png'; ?>"
				alt="<?php _e('Centered', 'rpbchessboard'); ?>"
			/>
		</label>
	</div>
	...
	<div>
		...
		/>
		<label for="rpbchessboard-diagramAlignmentButton-floatLeft" title="<?php _e('On the left of the text', 'rpbchessboard'); ?>">
			<img src="<?php echo RPBCHESSBOARD_URL . 'images/alignment-float-left.png'; ?>"
				alt="<?php _e('On the left of the text', 'rpbchessboard'); ?>"
			/>
		</label>
	</div>
	...
	<div>
		...
		/>
		<label for="rpbchessboard-diagramAlignmentButton-floatRight" title="<?php _e('On the right of the text', 'rpbchessboard'); ?>">
			<img src="<?php echo RPBCHESSBOARD_URL . 'images/alignment-float-right.png'; ?>"
				alt="<?php _e('On the right of the text', 'rpbchessboard'); ?>"
			/>
		</label>
	</div>
...
<p class="description">
	<?php _e('This setting affects how diagrams are inserted and placed within the rest of the text (by default).', 'rpbchessboard'); ?>
</p>
