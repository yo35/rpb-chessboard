...
<div class="rpbchessboard-columns">
	<div>
		<p><?php _e('Two alternative syntaxes exist for PGN games:', 'rpbchessboard'); ?></p>
		...
		<p>
			<?php echo sprintf(
				__(
					'With this alternative syntax, the game is described by the code between the %1$s tags. '.
