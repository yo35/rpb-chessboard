...
(function($) {
	...
	i18n.PIECE_SYMBOLS = { 'K':'Кр', 'Q':'Ф', 'R':'Л', 'B':'С', 'N':'К', 'P':'п' };

	i18n.ANNOTATED_BY               = 'Комментарии %1$s';
	i18n.INITIAL_POSITION           = 'Начальная позиция';
	...
	i18n.FLIP_TOOLTIP               = 'Перевернуть доску';
