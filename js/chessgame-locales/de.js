...
(function($) {
	...
	i18n.PIECE_SYMBOLS = { 'K':'K', 'Q':'D', 'R':'T', 'B':'L', 'N':'S', 'P':'B' };

	i18n.ANNOTATED_BY               = 'Kommentiert durch %1$s';
	i18n.INITIAL_POSITION           = 'Initiale Stellung';
	...
	//i18n.FLIP_TOOLTIP               = 'Flip the board';
