...
/**
 * Base model for the PGN-based shortcodes.
 */
abstract class RPBChessboardModelShortcodeAbstractPGN extends RPBChessboardAbstractModelShortcode {
