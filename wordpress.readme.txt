...
= 8.0.0 (May 9, 2024) =
* Add auto-play (see [#91](https://github.com/yo35/rpb-chessboard/issues/91)).
* Adapt button size in the navigation toolbar to the size of the board (see [#274](https://github.com/yo35/rpb-chessboard/issues/274)).
...
= 7.9.0 (March 9, 2024) =
* Add support for NAGs 20 and 21 (see [#280](https://github.com/yo35/rpb-chessboard/issues/280)).

= 7.8.0 (January 1, 2024) =
* Add an option to show/hide the turn flag in the diagrams (see [#270](https://github.com/yo35/rpb-chessboard/issues/270)).

= 7.7.1 (November 11, 2023) =
* Tested up to WordPress 6.4.

= 7.7.0 (August 9, 2023) =
* Tested up to WordPress 6.3.
* Fix size of the text area in the chess game block editor (see [#267](https://github.com/yo35/rpb-chessboard/issues/267)).

= 7.6.0 (June 3, 2023) =
* Chess game block allows to upload a PGN file and use it as data source.

= 7.5.4 (May 26, 2023) =
* Fix focus issue in the navigation frame (see [#263](https://github.com/yo35/rpb-chessboard/issues/263)).
...
= 7.5.1 (April 10, 2023) =
* Fix comment parsing issue (see [#260](https://github.com/yo35/rpb-chessboard/issues/260)).

= 7.5.0 (April 9, 2023) =
* The `[fen][/fen]` and `[pgn][/pgn]` shortcodes are no longer considered as deprecated (several people are still using the classic post/page editor).
* Add shortcode attribute `initial_selection` to `[pgn][/pgn]` to customize of the initial move (see [#259](https://github.com/yo35/rpb-chessboard/issues/259)).

= 7.4.1 (March 29, 2023) =
* Tested up to WordPress 6.2.

= 7.4.0 (March 18, 2023) =
* Add support for NAG 9 (see [#255](https://github.com/yo35/rpb-chessboard/issues/255)).

= 7.3.10 (March 11, 2023) =
* Fix chess diagram block not properly rendered with starting position (see [#256](https://github.com/yo35/rpb-chessboard/issues/256)).

= 7.3.9 (March 5, 2023) =
* Fix navigation popup display on mobile devices (see [#253](https://github.com/yo35/rpb-chessboard/issues/253)).

= 7.3.8 (February 1, 2023) =
* Fix drag-drop not working in the diagram editor on mobile devices.

= 7.3.7 (January 8, 2023) =
* Minor fixes.
...
= 7.0.0 (May 16, 2022) =
* Add chess game block with its editor to the Gutenberg-based WordPress post/page editor.
* Significant code refactoring of the chess game component, which is now released as a standalone NPM library (kokopu-react).
* The `[fen][/fen]` and `[pgn][/pgn]` shortcodes are now considered as deprecated: from now on, it is advised to use the chess diagram and chess game blocks to insert chess content in posts and pages.
...
= 6.0.0 (May 30, 2021) =
* Add chess diagram block with its editor to the Gutenberg-based WordPress post/page editor.
* Drop support for the old TinyMCE-based WordPress post/page editor.
...
* Fix (again) post/page rendering for Gutenberg (see [#137](https://github.com/yo35/rpb-chessboard/issues/137)).
...
* Fix post/page rendering for Gutenberg (see [#137](https://github.com/yo35/rpb-chessboard/issues/137)).
