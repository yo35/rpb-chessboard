...
class RPBChessboardModelInitScript {
	...
	private function getDefaultSettings() {
		return array(
			...
			'sdoTurnVisible'       => $this->mainModel->getDefaultShowTurn( 'sdo' ),
			'nboTurnVisible'       => $this->mainModel->getDefaultShowTurn( 'nbo' ),
			'idoTurnVisible'       => $this->mainModel->getDefaultShowTurn( 'ido' ),
	...
	private static function getJsI18n() {
		return array(
			...
			'FEN_EDITOR_CONTROL_TURN_FLAG'            => __( 'Turn flag', 'rpb-chessboard' ),
